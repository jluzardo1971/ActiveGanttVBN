...
#Region "Form Loaded"
    ...
    Private Sub fMSProject12_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "The Source Code Store - ActiveGantt Scheduler Control Version " & ActiveGanttVBNCtl1.Version & " - Microsoft Project 2007 integration using XML Files and the MSP2007 Integration Library"
        Me.Left = Owner.Left
        Me.Top = Owner.Top
...
#Region "Form Resizing"
    ...
    Private Sub fMSProject12_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        GroupBox1.Left = 8
        GroupBox1.Top = 60
...
#Region "Functions"
    ...
    Private Sub InitializeAG()
        ...
        ActiveGanttVBNCtl1.Style.BorderColor = Color.FromArgb(255, 122, 151, 193)
        ActiveGanttVBNCtl1.Style.BorderWidth = 1

        ActiveGanttVBNCtl1.Splitter.Type = E_SPLITTERTYPE.SA_USERDEFINED
        ActiveGanttVBNCtl1.Splitter.Width = 4
        ActiveGanttVBNCtl1.Splitter.SetColor(1, Color.FromArgb(255, 197, 206, 216))
        ActiveGanttVBNCtl1.Splitter.SetColor(2, Color.White)
        ActiveGanttVBNCtl1.Splitter.SetColor(3, Color.White)
        ActiveGanttVBNCtl1.Splitter.SetColor(4, Color.FromArgb(255, 197, 206, 216))
        ...
        ActiveGanttVBNCtl1.ScrollBarSeparator.Style.Appearance = E_STYLEAPPEARANCE.SA_FLAT
        ActiveGanttVBNCtl1.ScrollBarSeparator.Style.BackgroundMode = GRE_BACKGROUNDMODE.FP_SOLID
        ActiveGanttVBNCtl1.ScrollBarSeparator.Style.BackColor = Color.FromArgb(255, 164, 196, 237)
        ...
        ActiveGanttVBNCtl1.VerticalScrollBar.ScrollBar.ThumbButton.PressedStyleIndex = "ThumbButtonV"
        ...
        ActiveGanttVBNCtl1.HorizontalScrollBar.ScrollBar.ThumbButton.PressedStyleIndex = "ThumbButtonH"
    ...
    Private Sub MP12_To_AG()
        ...
        Dim oMPTask As MSP2007.Task = Nothing
        ...
        For i = 1 To oMP12.oTasks.Count
            ...
            For j = 1 To oMPTask.oPredecessorLink_C.Count
                Dim oMPPredecessor As MSP2007.TaskPredecessorLink = Nothing
        ...
        For i = 1 To oMP12.oAssignments.Count
            Dim oAssignment As MSP2007.Assignment = Nothing
    ...
    Private Function GetAGPredecessorType(ByVal MPPredecessorType As MSP2007.E_TYPE_5) As AGVBN.E_CONSTRAINTTYPE
...
#Region "Menu Items"
    ...
    Private Sub LoadMSProject2007XMLFileToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoadMSProject2007XMLFileToolStripMenuItem.Click
        LoadXML()
    End Sub

    Private Sub SaveMSProject2007XMLFileToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveMSProject2007XMLFileToolStripMenuItem.Click
        SaveXML()
    End Sub
