...
Public Class fRCT_YEAR
    ...
    Private Sub fRCT_YEAR_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oView = ActiveGanttVBNCtl1.Views.Add(E_INTERVAL.IL_DAY, 1, E_TIERTYPE.ST_YEAR, E_TIERTYPE.ST_DAYOFWEEK, E_TIERTYPE.ST_MONTH, "View1")
        oView.TimeLine.TierArea.MiddleTier.Visible = False
        oView.TimeLine.TickMarkArea.Visible = False

        ActiveGanttVBNCtl1.TierFormatScope = E_TIERFORMATSCOPE.TFS_CONTROL
        ActiveGanttVBNCtl1.TierFormat.MonthIntervalFormat = "MM"
        ...
        dtDate = New AGVBN.DateTime(2000, 12, 23, 0, 0, 0)
