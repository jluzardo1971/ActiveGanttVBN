...
Module DST_ACCESS
    ...
    Public Function g_DST_ACCESS_GetDatabaseLocation() As String
        Return System.Windows.Forms.Application.StartupPath.Replace("\bin", "") & "\ActiveGanttExamples.mdb"
    End Function
    ...
    Public Function g_DST_ACCESS_ConvertDate(ByVal dtDate As AGVBN.DateTime) As String
