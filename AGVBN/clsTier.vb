...
Public Class clsTier
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBNCtl, ByVal oTierArea As clsTierArea, ByVal yTierPosition As E_TIERPOSITION)
        mp_oControl = Value
    ...
    Private Sub Draw(ByVal dtStart As AGVBN.DateTime, ByVal dtEnd As AGVBN.DateTime, ByVal lTop As Integer, ByVal lBottom As Integer)
