...
Friend Class clsMouseKeyboardEvents
    ...
    Private Structure S_TASKMOVEMENT
        ...
        Public dtInitialStartDate As AGVBN.DateTime
        Public dtInitialEndDate As AGVBN.DateTime
        ...
        Public Sub Clear()
            ...
            sInitialRowKey = ""
            lFinalRowIndex = 0
            dtInitialStartDate = New AGVBN.DateTime()
            dtInitialEndDate = New AGVBN.DateTime()
            lDeltaLeft = 0
            lDeltaRight = 0
            lDurationFactor = 0
        End Sub
    ...
    Private Structure S_TASKSTRETCHLEFT
        Public dtInitialStartDate As AGVBN.DateTime
        Public dtInitialEndDate As AGVBN.DateTime
        Public dtFinalStartDate As AGVBN.DateTime
        Public lRowIndex As Integer
        Public Sub Clear()
            dtInitialStartDate = New AGVBN.DateTime()
            dtInitialEndDate = New AGVBN.DateTime()
            dtFinalStartDate = New AGVBN.DateTime()
            lRowIndex = 0
        End Sub
    End Structure
    ...
    Private Structure S_TASKSTRETCHRIGHT
        Public dtInitialStartDate As AGVBN.DateTime
        Public dtInitialEndDate As AGVBN.DateTime
        Public dtFinalEndDate As AGVBN.DateTime
        Public lRowIndex As Integer
        Public Sub Clear()
            dtInitialStartDate = New AGVBN.DateTime()
            dtInitialEndDate = New AGVBN.DateTime()
            dtFinalEndDate = New AGVBN.DateTime()
            lRowIndex = 0
        End Sub
    End Structure
    ...
    Private Structure S_TASKADDITION
        ...
        Public dtStartDate As AGVBN.DateTime
        Public dtEndDate As AGVBN.DateTime
        Public lRowIndex As Integer
        Public Sub Clear()
            bCancel = False
            bInConflict = False
            dtStartDate = New AGVBN.DateTime()
            dtEndDate = New AGVBN.DateTime()
            lRowIndex = 0
        End Sub
    End Structure
    ...
    Friend Sub KeyDown(ByVal KeyCode As System.Windows.Forms.Keys)
    ...
    Friend Sub KeyUp(ByVal KeyCode As System.Windows.Forms.Keys)
        mp_oControl.KeyEventArgs.Clear()
        mp_oControl.KeyEventArgs.KeyCode = KeyCode
        mp_oControl.KeyEventArgs.Cancel = False
    ...
    Friend Sub OnMouseDown(ByVal X As Integer, ByVal Y As Integer, ByVal Button As System.Windows.Forms.MouseButtons)
                ...
                If s_tskADD.bCancel = False And s_tskADD.bInConflict = False Then
                    ...
                    If s_tskADD.dtEndDate = s_tskADD.dtStartDate Then
                        ...
                        ElseIf mp_oControl.AddMode = E_ADDMODE.AT_DURATION_BOTH Or mp_oControl.AddMode = E_ADDMODE.AT_DURATION_MILESTONEADD Then
                            Dim dtStartDate As AGVBN.DateTime = s_tskADD.dtStartDate
                            Dim dtTLStartDate As AGVBN.DateTime = mp_oControl.CurrentViewObject.TimeLine.StartDate
                            Dim dtTLEndDate As AGVBN.DateTime = mp_oControl.CurrentViewObject.TimeLine.EndDate
    ...
    Private Function mp_fSnapX(ByVal X As Integer) As Integer
        Dim dtDate As AGVBN.DateTime = New AGVBN.DateTime()
