...
Public Class clsProgressLine
    ...
    Private mp_dtPosition As AGVBN.DateTime
    Private mp_yLength As E_PROGRESSLINELENGTH
    Private mp_yLineType As E_PROGRESSLINETYPE
    Private mp_oTimeLine As clsTimeLine

    Friend Sub New(ByVal Value As ActiveGanttVBNCtl, ByVal oTimeLine As clsTimeLine)
        mp_oControl = Value
        mp_clrForeColor = Color.Red
        mp_dtPosition = New AGVBN.DateTime()
    ...
    Public Property Position() As AGVBN.DateTime
        Get
    ...
    Friend Sub Draw()
        ...
        Dim dtDate As New AGVBN.DateTime()
