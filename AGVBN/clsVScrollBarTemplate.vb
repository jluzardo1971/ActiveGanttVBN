...
Public Class clsVScrollBarTemplate
    ...
    Private mp_oTimer As New System.Timers.Timer()
    ...
    Friend Sub Initialize(ByVal oControl As ActiveGanttVBNCtl)
        ...
        mp_lValueBuff = Value
        AddHandler mp_oTimer.Elapsed, AddressOf mp_oTimer_Tick
    ...
    Private Sub mp_oTimer_Tick(ByVal source As Object, ByVal e As ElapsedEventArgs)
