...
Public Class clsTimeBlocks
    ...
    Private mp_dtIntervalStart As AGVBN.DateTime
    Private mp_dtIntervalEnd As AGVBN.DateTime
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBNCtl)
        ...
        mp_dtIntervalStart = New AGVBN.DateTime()
        mp_dtIntervalEnd = New AGVBN.DateTime()
    ...
    Friend Sub CreateTemporaryTimeBlocks()
        ...
        For lIndex = 1 To Count
            ...
            Dim dtTimeLineStart As AGVBN.DateTime = New AGVBN.DateTime()
            Dim dtTimeLineEnd As AGVBN.DateTime = New AGVBN.DateTime()
            Dim dtCurrent As AGVBN.DateTime = New AGVBN.DateTime()
            Dim dtStartBuff As AGVBN.DateTime = New AGVBN.DateTime()
            Dim dtEndBuff As AGVBN.DateTime = New AGVBN.DateTime()
    ...
    Public Property IntervalStart() As AGVBN.DateTime
        Get
            Return mp_dtIntervalStart
        End Get
        Set(ByVal value As AGVBN.DateTime)
            mp_dtIntervalStart = value
        End Set
    End Property

    Public Property IntervalEnd() As AGVBN.DateTime
        Get
