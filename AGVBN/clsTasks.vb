...
Public Class clsTasks
    ...
    Public Function Add(ByVal Text As String, ByVal RowKey As String, ByVal StartDate As AGVBN.DateTime, ByVal EndDate As AGVBN.DateTime, Optional ByVal Key As String = "", Optional ByVal StyleIndex As String = "", Optional ByVal LayerIndex As String = "0") As clsTask
    ...
    Public Function DAdd(ByVal RowKey As String, ByVal StartDate As AGVBN.DateTime, ByVal DurationInterval As E_INTERVAL, ByVal DurationFactor As Integer, Optional ByVal Text As String = "", Optional ByVal Key As String = "", Optional ByVal StyleIndex As String = "", Optional ByVal LayerIndex As String = "0") As clsTask
        mp_oCollection.AddMode = True
        Dim oTask As New clsTask(mp_oControl)
