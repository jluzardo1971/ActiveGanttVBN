...
Public Class clsPredecessor
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBNCtl, ByVal oPredecessors As clsPredecessors)
        mp_oControl = Value
        mp_bVisible = True
    ...
    Public Sub Check(ByVal Mode As E_PREDECESSORMODE)
        Dim dtPredecessor As AGVBN.DateTime = New AGVBN.DateTime()
        Dim dtSuccessor As AGVBN.DateTime = New AGVBN.DateTime()
