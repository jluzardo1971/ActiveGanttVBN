...
Public Class clsTask
    ...
    Friend mp_lTextLeft As Integer
    Friend mp_lTextTop As Integer
    Friend mp_lTextRight As Integer
    Friend mp_lTextBottom As Integer
    ...
    Public Sub New(ByVal Value As ActiveGanttVBNCtl)
        mp_oControl = Value
    ...
    Public Property RowKey() As String
        ...
        Set(ByVal Value As String)
            If mp_oControl.Rows.oCollection.m_bDoesKeyExist(Value) = False Then
                mp_oControl.mp_ErrorReport(SYS_ERRORS.INVALID_ROW_KEY, "Invalid Row Key (""" & Value & """)", "ActiveGanttVBNCtl.clsTask.Let RowKey")
                Exit Property
            End If
            mp_sRowKey = Value
    ...
    Public Property StartDate() As AGVBN.DateTime
        Get
    ...
    Public Property EndDate() As AGVBN.DateTime
        Get
            Return mp_dtEndDate
        End Get
        Set(ByVal Value As AGVBN.DateTime)
