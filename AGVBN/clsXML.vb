...
Partial Friend Class clsXML
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBNCtl, ByVal sObject As String)
        mp_oControl = Value
    ...
    Friend Sub ReadProperty(ByVal sElementName As String, ByRef oDate As AGVBN.DateTime)
        Dim mp_yBackupLevel As PE_LEVEL
    ...
    Friend Sub WriteProperty(ByVal sElementName As String, ByRef oDate As AGVBN.DateTime)
        Dim mp_yBackupLevel As PE_LEVEL
        mp_yBackupLevel = mp_yLevel
