...
Public Class clsTimeLine
    ...
    Friend Sub New(ByVal Value As ActiveGanttVBNCtl, ByVal oView As clsView)
        mp_oControl = Value
        mp_oView = oView
        ...
        Dim dtTimeNow As AGVBN.DateTime = New AGVBN.DateTime()
    ...
    Public ReadOnly Property EndDate() As AGVBN.DateTime
        Get
            Calculate()
    ...
    Public ReadOnly Property StartDate() As AGVBN.DateTime
        Get
            Return mp_dtStartDate
        End Get
    End Property

    Friend WriteOnly Property f_StartDate() As AGVBN.DateTime
    ...
    Public Sub Position(ByVal TimeLineStartDate As AGVBN.DateTime)
