...
Public Class DateTime
    ...
    Public Shared ReadOnly Property Now() As AGVBN.DateTime
        Get
            Dim dtResult As AGVBN.DateTime = New AGVBN.DateTime()
    ...
    Public Shared Operator =(ByVal DateTime1 As AGVBN.DateTime, ByVal DateTime2 As AGVBN.DateTime) As Boolean
    ...
    Public Overloads Overrides Function Equals(ByVal obj As Object) As Boolean
        If obj Is Nothing Or Not Me.GetType() Is obj.GetType() Then
            Return False
        End If
        Dim DateTime2 As AGVBN.DateTime = CType(obj, AGVBN.DateTime)
    ...
    Public Overloads Function Equals(ByVal DateTime2 As AGVBN.DateTime) As Boolean
        If ((mp_dtDateTime = DateTime2.mp_dtDateTime) And (mp_lSecondFraction = DateTime2.mp_lSecondFraction)) Then
            Return True
        Else
            Return False
