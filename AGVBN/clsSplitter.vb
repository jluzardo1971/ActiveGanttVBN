...
Public Class clsSplitter
    ...
    Public Sub SetColor(ByVal Index As Integer, ByVal oColor As Color)
        ...
        If mp_yType <> E_SPLITTERTYPE.SA_USERDEFINED Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALIDOP, "Invalid Operation", "ActiveGanttVBNCtl.clsSplitter.SetColor")
            Return
        End If
        If Index < 0 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBNCtl.clsSplitter.SetColor")
            Return
        End If
    ...
    Public Function GetColor(ByVal Index As Integer) As Color
        Index = Index - 1
        If mp_yType <> E_SPLITTERTYPE.SA_USERDEFINED Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALIDOP, "Invalid Operation", "ActiveGanttVBNCtl.clsSplitter.GetColor")
            Return Nothing
        End If
        If Index < 0 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBNCtl.clsSplitter.GetColor")
            Return Nothing
        End If
        If Index > mp_aColors.Count - 1 Then
            mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_INDEX, "Invalid Index", "ActiveGanttVBNCtl.clsSplitter.GetColor")
    ...
    Public Property Width() As Integer
        ...
        Set(ByVal Value As Integer)
            ...
            Else
                If Value < 0 Then
                    mp_oControl.mp_ErrorReport(SYS_ERRORS.SPLITTER_INVALID_WIDTH, "Invalid Width Value", "ActiveGanttVBNCtl.clsSplitter.Width")
                    Return
                End If
                mp_lWidth = Value
            End If
